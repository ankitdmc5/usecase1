...
public class CompanyService {
    ...
    public CompanyVO getCompanyDetail(Long companyCode) throws Exception {
        ...
        if (company.isPresent()) {
            ResponseEntity<Stock> response = this.restTemplate.exchange("http://STOCK-SERVICE/api/v1.0/stock/getLatest/" + companyCode, HttpMethod.GET, null, Stock.class);
    ...
    public List<CompanyVO> getAllCompanies() {
        ...
        companies.forEach(company -> {
            ResponseEntity<Stock> response = this.restTemplate.exchange("http://STOCK-SERVICE/api/v1.0/stock/getLatest/" + company.getCompanyCode(), HttpMethod.GET, null, Stock.class);
    ...
    public void deleteCompanyWithAllStockPrices(Long companyCode) {
        this.companyRepository.deleteById(companyCode);
        this.restTemplate.exchange("http://STOCK-SERVICE/api/v1.0/stock/deleteAll/" + companyCode, HttpMethod.DELETE, null, Stock.class);
    }
}
